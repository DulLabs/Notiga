...
class NotificationAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val mIconImage = itemView.findViewById<ImageView>(R.id.notificationIconImage)
        private val mAppName = itemView.findViewById<TextView>(R.id.notificationAppName)
